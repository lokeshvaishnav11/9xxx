        ...
        #    firstparentgivemoney = paymoney*
            ...
            if (bet_On != BetOn['CASINO']):
                ...
                if(exposerone == "mafailed"):
                    return json.dumps(error({}, "One Match Bookmaker Limit completed"), cls=JSONEncoderWithObjectId)
                if(exposerone == "ffailed"):
                    return json.dumps(error({}, "One Match Session Limit completed"), cls=JSONEncoderWithObjectId)

...
exports.userStakeValidation = [
    ...
    (0, express_validator_1.check)('name11', 'Name11 is requied').not().isEmpty(),
    (0, express_validator_1.check)('value11', 'Value11 is requied').not().isEmpty(),
    (0, express_validator_1.check)('name12', 'Name12 is requied').not().isEmpty(),
    (0, express_validator_1.check)('value12', 'Value12 is requied').not().isEmpty(),
    (0, express_validator_1.check)('name13', 'Name13 is requied').not().isEmpty(),
    (0, express_validator_1.check)('value13', 'Value13 is requied').not().isEmpty(),
];
